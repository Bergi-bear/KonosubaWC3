...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("H000"), -131.3, -87.5, -87.374, FourCC("H000"))
    u = BlzCreateUnitWithSkin(p, FourCC("H001"), -278.4, -75.1, -46.701, FourCC("H001"))
    u = BlzCreateUnitWithSkin(p, FourCC("H002"), -36.5, -81.3, 229.478, FourCC("H002"))
end
...
function config()
    ...
    DefineStartLocation(0, -1408.0, 1600.0)
