...
function CreateUnitsForPlayer10()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -96.6, 847.1, 264.888, FourCC("nban"))
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -44.6, 776.6, 38.651, FourCC("nban"))
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -7.4, 718.6, 256.088, FourCC("nban"))
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -70.4, 701.2, 354.551, FourCC("nban"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -965.3, 36.5, 244.201, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -921.8, 30.3, 128.621, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -911.1, -57.1, 107.779, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -946.1, -141.1, 223.513, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -1021.9, -135.6, 76.028, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -1049.0, -96.9, 171.853, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -1033.5, -31.0, 271.437, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -978.0, -10.3, 225.435, FourCC("hpea"))
end
